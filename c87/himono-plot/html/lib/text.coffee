window.texts = [
  image.background 'img/bg/LGTM.png'
  ...
  "「どちらまで？」"
  image.background 'img/bg/hozuki.png'
  "少女は淡々と答えた。"
  "「世界の果てまで」"
  "クリスは後部座席へ振り返り、そして正面へ向き直し、肩を竦め眉間に皺を寄せる。"
  image.background 'img/bg/LGTM.png'
  "「残念だったな、お嬢ちゃん。世界に果てがないってのは500年も昔にイタリア生まれのドンキホーテが証明してるんだ。さあ、とっとと降りろ」"
  ...
  image.background 'img/bg/eva.jpg'
  ...
  "クリスは店を出てから、ちょうど目の前を走る車に目をつける。そして、その車の前へ飛び出した。"
